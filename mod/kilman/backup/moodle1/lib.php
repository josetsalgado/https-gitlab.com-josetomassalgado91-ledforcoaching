 ...
 */
class moodle1_mod_kilman_handler extends moodle1_mod_handler {
    ...
    public function get_paths() {
        return array(
            new convert_path(
                'kilman', '/MOODLE_BACKUP/COURSE/MODULES/MOD/kilman',
                array(
                    'renamefields' => array(
                        'summary' => 'intro',
                    ),
            ...
            new convert_path('survey', '/MOODLE_BACKUP/COURSE/MODULES/MOD/kilman/SURVEY'),
            new convert_path('question', '/MOODLE_BACKUP/COURSE/MODULES/MOD/kilman/SURVEY/QUESTION'),
            new convert_path('question_choice', '/MOODLE_BACKUP/COURSE/MODULES/MOD/kilman/SURVEY/QUESTION/QUESTION_CHOICE'),
        );
    }
    /**
     * This is executed every time we have one /MOODLE_BACKUP/COURSE/MODULES/MOD/kilman
     * data available
     */
    public function process_kilman($data) {
        ...
        $this->open_xml_writer("activities/kilman_{$moduleid}/kilman.xml");
        $this->xmlwriter->begin_tag('activity', array('id' => $instanceid, 'moduleid' => $moduleid,
            'modulename' => 'kilman', 'contextid' => $contextid));
        $this->xmlwriter->begin_tag('kilman', array('id' => $instanceid));
    ...
    /**
     * This is executed when we reach the closing </MOD> tag of our 'kilman' path
     */

    public function on_kilman_end() {
        // Close kilman.xml.
        $this->xmlwriter->end_tag('surveys');
        $this->xmlwriter->end_tag('kilman');
        $this->xmlwriter->end_tag('activity');
        $this->close_xml_writer();
    }
    /**
     * This is executed every time we have one /MOODLE_BACKUP/COURSE/MODULES/MOD/kilman/SURVEY
     * data available
     */
    ...
    /**
     * This is executed every time we have one /MOODLE_BACKUP/COURSE/MODULES/MOD/kilman/SURVEY/QUESTION
     * data available
     */
    ...
    /**
     * This is executed every time we have one /MOODLE_BACKUP/COURSE/MODULES/MOD/kilman/SURVEY/QUESTION/QUESTION_CHOICE
     * data available
     */
