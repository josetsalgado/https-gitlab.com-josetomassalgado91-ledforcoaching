@mod @mod_kilman
Feature: In kilman, personality tests can be constructed using feedback on specific question responses.
  In order to define a feedback kilman
  As a teacher
  I must add the required question types and complete the feedback options.

  @javascript
  Scenario: Create a kilman with a rate question type and verify that feedback options exist.
    ...
    And the following "activities" exist:
      ...
      | kilman | Test kilman | Test kilman description | C1 | kilman0 | 1 | 1 |
    And I log in as "teacher1"
    And I am on "Course 1" course homepage
    And I follow "Test kilman"
    And I navigate to "Feedback" in current page administration
    Then I should see "Feedback options are available if your kilman contains the following question types"
