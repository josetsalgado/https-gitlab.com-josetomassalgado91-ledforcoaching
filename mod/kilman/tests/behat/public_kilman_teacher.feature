@mod @mod_kilman
Feature: Public kilmans gather all instance responses in one master course, but not in the instance courses.
  When teachers view a course instance they will not see any student responses.
  When teachers view the main public course kilman, they will see all instances' responses.
  ...
  @javascript
  Scenario: Teacher should not see responses for a kilman using a public instance
    And I log in as "teacher2"
    And I am on "Course 2" course homepage with editing mode on
    And I follow "kilman instance 1"
  ...
  # Scenario: Teacher in course with main public kilman should see all responses
    And I log in as "teacher1"
    And I am on "Course 1" course homepage
    And I follow "Public kilman"
