@mod @mod_kilman
Feature: Add questions to a kilman activity
  In order to conduct surveys of the users in a course
  As a teacher
  I need to add a kilman activity with questions to a moodle course

@javascript
  Scenario: Add a kilman to a course with one of each question type
