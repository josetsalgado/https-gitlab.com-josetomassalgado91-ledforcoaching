@mod @mod_kilman
Feature: In kilman, yes/no questions can be defined with scores attributed to specific answers, in order
  ...
  @javascript
  Scenario: Create a kilman with a yes/no question type and verify that feedback options exist.
