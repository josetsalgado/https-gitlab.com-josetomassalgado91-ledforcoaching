@mod @mod_kilman
Feature: In kilman, radio questions can be defined with scores attributed to specific answers, in order
  ...
  @javascript
  Scenario: Create a kilman with a radio question type and verify that feedback options exist.
