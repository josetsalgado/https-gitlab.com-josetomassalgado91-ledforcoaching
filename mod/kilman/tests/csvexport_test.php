...
/**
 * Performance test for kilman module.
 * @group mod_kilman
 * @author     Guy Thomas
 * @copyright Copyright (c) 2015 Moodlerooms Inc. (http://www.moodlerooms.com)
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class mod_kilman_csvexport_test extends advanced_testcase {
    ...
    public function test_csvexport() {
        ...
        foreach ($kilmans as $kilman) {
            ...
            $kilmaninst = new kilman(0, $kilman, $course, $cm);

            // Test for only complete responses.
            $newoutput = $this->get_csv_text($kilmaninst->generate_csv('', '', 0, 0, 0, 0));
            ...
            $newoutput = $this->get_csv_text($kilmaninst->generate_csv('', '', 0, 0, 0, 1));
