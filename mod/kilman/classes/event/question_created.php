...
/**
 * The mod_kilman question_created event.
 *
 * @package    mod_kilman
...
/**
 * The mod_kilman question_created event class.
 *
 * @package    mod_kilman
 * @since      Moodle 2.7
 * @copyright  2014 Joseph Rézeau <moodle@rezeau.org>
...
class question_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('event_question_created', 'mod_kilman');
    }
    ...
    public function get_description() {
        ...
        return "The user with id '$this->userid' has created or modified a question of type '$questiontype' for
            the kilman with course module id '$this->contextinstanceid'.";
    }
}