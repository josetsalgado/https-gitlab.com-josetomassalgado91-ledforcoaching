...
abstract class base {
    ...
    public function get_results_tags($weights, $participants, $respondents, $showtotals = 1, $sort = '') {
        ...
        $precision = 0;
        $alt = '';
        $imageurl = $CFG->wwwroot.'/mod/kilman/images/';
    ...
    /**
     * Return all the fields to be used for users in bulk kilman sql.
     *
     * @author: Guy Thomas
     * @return string
     */
    ...
    protected function bulk_sql_config() {
        return new bulk_sql_config('kilman_response_other', 'qro', true, true, false);
    }
