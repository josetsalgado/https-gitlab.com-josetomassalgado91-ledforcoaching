...
class check extends base {
    ...
    protected function responseclass() {
        return '\\mod_kilman\\response\\multiple';
    }
    ...
    public function question_template() {
        return 'mod_kilman/question_check';
    }
    ...
    public function response_template() {
        return 'mod_kilman/response_check';
    }
        ...
        if (!empty($data) ) {
            ...
            if ( $data->{'q'.$this->id} ) {
                ...
                if ($nbboxes < $min || $nbboxes > $max) {
                    $msg = get_string('boxesnbreq', 'kilman');
                    if ($min == $max) {
                        $msg .= '&nbsp;'.get_string('boxesnbexact', 'kilman', $min);
                    } else {
                        if ($min && ($nbboxes < $min)) {
                            $msg .= get_string('boxesnbmin', 'kilman', $min);
                            if ($nbboxes > $max) {
                                $msg .= ' & ' .get_string('boxesnbmax', 'kilman', $max);
                            }
                        } else {
                            if ($nbboxes > $max ) {
                                $msg .= get_string('boxesnbmax', 'kilman', $max);
