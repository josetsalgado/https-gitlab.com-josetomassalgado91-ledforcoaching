...
$string['activityoverview'] = 'You have kilmans that are due';
$string['additionalinfo'] = 'Additional Info';
$string['additionalinfo_help'] = 'Text to be displayed at the top of the first page of this kilman. (i.e. instructions, background info, etc.)';
...
$string['all'] = 'All';
$string['alreadyfilled'] = 'You have already filled out this kilman for us{$a}. Thank you.';
...
$string['attempted'] = 'This kilman has been submitted.';
...
$string['autonumbering_help'] = 'Automatic numbering of questions and pages. You might want to disable automatic numbering
 for kilmans with conditional branching.';
...
$string['cannotviewpublicresponses'] = 'You cannot view responses to this public kilman.';
...
$string['closed'] = 'The kilman was closed on {$a}. Thanks.';
$string['closedate'] = 'Use Close Date';
$string['closeson'] = 'kilman closes on {$a}';
$string['closedate_help'] = 'You can specify a date to close the kilman here. Check the check box, and select the date and time you want.
 Users will not be able to fill out the kilman after that date. If this is not selected, it will never be closed.';
$string['completionsubmit'] = 'Student must submit this kilman to complete it';
...
$string['confirmdelallresp'] = 'Are you sure you want to delete ALL the responses in this kilman?';
...
$string['confpage_help'] = 'Heading (in bold) and body text for the "Confirmation" page displayed after a user completes this kilman. (URL, if present, takes precedence over confirmation text.) If you leave this field empty, a default message will be displayed upon kilman completion (Thank you for completing this kilman).';
$string['confpagedesc'] = 'Heading (in bold) and body text for the &quot;Confirmation&quot; page displayed after a user completes this kilman. (URL, if present, takes precedence over confirmation text.)';
...
$string['deletedallresp'] = 'kilman responses deleted';
...
$string['downloadtextformat_help'] = 'This feature enables you to save all the responses of a kilman to a text file (CSV).
...
$string['event_previewed'] = 'kilman previewed';
...
$string['feedbackeditingglobal'] = 'Editing kilman Global Feedback';
$string['feedbackeditingsections'] = 'Editing kilman Feedback Sections';
$string['feedbackeditingmessages'] = 'Editing kilman Feedback Messages';
...
$string['feedbackoptions_help'] = 'Feedback options are available if your kilman contains the following question types and question settings:
...
$string['finished'] = 'You have answered all the questions in this kilman!';
$string['firstrespondent'] = 'First Respondent';
$string['formateditor'] = 'HTML editor';
$string['formatplain'] = 'Plain text';
$string['grade'] = 'Submission grade';
$string['gradesdeleted'] = 'kilman grades deleted';
...
Default values are 20 characters for the Input Box width and 25 characters for the maximum length of text entered.';
$string['messageprovider:message'] = 'kilman reminder';
$string['messageprovider:notification'] = 'kilman submission';
...
$string['modulename_help'] = 'The kilman module allows you to construct surveys using a variety of question types, for the purpose of gathering data from users.';
$string['modulenameplural'] = 'kilmans';
...
$string['navigate_help'] = 'Enable Yes/No and Radio Buttons questions to have Child questions dependent on their choices in your kilman.';
...
$string['noattempts'] = 'No attempts have been made on this kilman';
...
$string['noneinuse'] = 'This kilman does not contain any questions.';
$string['non_respondents'] = 'Users who have not yet submitted their responses to this kilman';
$string['nopublicsurveys'] = 'No public kilmans.';
...
$string['notavail'] = 'This kilman is no longer available. Ask your teacher to delete it.';
$string['noteligible'] = 'You are not eligible to take this kilman.';
$string['notemplatesurveys'] = 'No template kilmans.';
...
$string['notopen'] = 'This kilman will not open until {$a}.';
$string['notrequired'] = 'Response is not required';
$string['notset'] = 'not set';
$string['not_started'] = 'not started';
$string['nousersselected'] = 'No users selected';
$string['num'] = '#';
$string['numattemptsmade'] = '{$a} attempts made on this kilman';
...
$string['numberofdecimaldigits_help'] = 'Use **Nb of decimal digits** to specify the format of the Average value counted and displayed at the kilman Report page.';
...
$string['opendate_help'] = 'You can specify a date to open the kilman here. Check the check box, and select the date and time you want.
 Users will not be able to fill out the kilman before that date. If this is not selected, it will be open immediately.';
...
$string['optionalname_help'] = 'The Question Name is only used when you export responses to CSV/Excel format.
 ...
 If you plan to regularly export your kilman data to CSV, then you have a choice of two options for question naming. ';
...
When you arrive on the All Responses page, by default all responses are ordered in the order that the kilman creator entered the question choices.
...
$string['pluginadministration'] = 'kilman administration';
...
$string['preview_kilman'] = 'kilman Preview';
$string['previewing'] = ' Previewing kilman ';
$string['previous'] = 'Previous';
$string['previouspage'] = 'Previous Page';
$string['print'] = 'Print this Response';
$string['printblank'] = 'Print Blank';
$string['printblanktooltip'] = 'Opens printer-friendly window with blank kilman';
...
$string['privacy:metadata:kilman_response:kilmanid'] = 'The ID of the kilman record for this response.';
...
$string['kilman:addinstance'] = 'Add a new kilman';
$string['kilman:copysurveys'] = 'Copy template and private kilmans';
$string['kilman:createpublic'] = 'Create public kilmans';
$string['kilman:createtemplates'] = 'Create template kilmans';
$string['kilman:deleteresponses'] = 'Delete any response';
$string['kilman:downloadresponses'] = 'Download responses in a CSV file';
$string['kilman:editquestions'] = 'Create and edit kilman questions';
$string['kilman:manage'] = 'Create and edit kilmans';
$string['kilman:message'] = 'Send message to non-respondents';
$string['kilman:preview'] = 'Preview kilmans';
$string['kilman:printblank'] = 'Print blank kilman';
...
$string['kilman:submit'] = 'Complete and submit a kilman';
$string['kilman:view'] = 'View a kilman';
$string['kilman:viewsingleresponse'] = 'View complete individual responses';
$string['kilmanadministration'] = 'kilman Administration';
$string['kilmancloses'] = 'kilman Closes';
$string['kilmanopens'] = 'kilman Opens';
$string['kilmanreport'] = 'kilman Report';
...
$string['realm'] = 'kilman Type';
$string['realm_help'] = '* **There are  three types of kilmans:**
...
$string['redirecturl'] = 'The URL to which a user is redirected after completing this kilman.';
$string['remove'] = 'Delete';
$string['removenotinuse'] = 'This kilman used to depend on a Public kilman which has been deleted.
...
the respondent will not be able to submit the kilman
...
$string['reset'] = 'Reset';
$string['removeallkilmanattempts'] = 'Delete all kilman responses';
...
$string['responseviewstudentswhenanswered'] = 'After answering the kilman';
$string['responseviewstudentswhenclosed'] = 'After the kilman is closed';
$string['restrictedtoteacher'] = 'These functions are restricted to editing teachers only!';
$string['resume'] = 'Save/Resume answers';
$string['resume_help'] = 'Setting this option allows users to save their answers to a kilman before submitting them.
 Users can leave the kilman unfinished and resume from the save point at a later date.';
$string['resume_link'] = 'mod/kilman/mod#Save/Resume_answers';
$string['resumesurvey'] = 'Resume kilman';
$string['return'] = 'Return';
$string['save'] = 'Save';
$string['saveasnew'] = 'Save as New Question';
$string['savedbutnotsubmitted'] = 'This kilman has been saved but not yet submitted.';
$string['savedprogress'] = 'Your progress has been saved.  You may return at any time to complete this kilman.';
$string['saveeditedquestion'] = 'Save question {$a}';
$string['savesettings'] = 'Save settings';
$string['search:activity'] = 'kilman - activity information';
$string['search:question'] = 'kilman - questions';
...
$string['selecttheme'] = 'Select a theme (css) to use with this kilman.';
$string['send'] = 'Send';
...
$string['submissionnotificationhtmlanon'] = 'There is a new <a href="{$a->submissionurl}">submission</a> to the "{$a->name}" kilman.';
$string['submissionnotificationhtmluser'] = '<a href="{$a->profileurl}">{$a->username}</a> has a new <a href="{$a->submissionurl}">submission</a> to the "{$a->name}" kilman in the course "{$a->coursename}".';
$string['submissionnotificationsubject'] = 'New kilman submission';
$string['submissionnotificationtextanon'] = 'There is a new submission ({$a->submissionurl}) to the "{$a->name}" kilman.';
$string['submissionnotificationtextuser'] = '{$a->username} ({$a->profileurl}) has a new submission ({$a->submissionurl}) to the "{$a->name}" kilman in the course "{$a->coursename}".';
...
$string['submitsurvey'] = 'Submit kilman';
$string['submitted'] = 'Submitted on:';
$string['subtitle'] = 'Subtitle';
$string['subtitle_help'] = 'Subtitle of this kilman. Appears below the title on the first page only.';
$string['subject'] = 'Subject';
$string['summary'] = 'Summary';
$string['surveynotexists'] = 'kilman does not exist.';
$string['surveyowner'] = 'You must be a kilman owner to perform this operation.';
$string['surveyresponse'] = 'Response from kilman';
$string['template'] = 'Template';
$string['templatenotviewable'] = 'Template kilmans are not viewable.';
...
$string['thank_head'] = 'Thank you for completing this kilman.';
$string['theme'] = 'Theme';
...
$string['title'] = 'Title';
$string['title_help'] = 'Title of this kilman, which will appear at the top of every page. By default Title is set to the kilman Name, but you can edit it as you like.';
$string['today'] = 'today';
$string['total'] = 'Total';
...
$string['unknownaction'] = 'Unknown kilman action specified...';
$string['url'] = 'Confirmation URL';
$string['url_help'] = 'The URL to which a user is redirected after completing this kilman.';
...
$string['viewallresponses_help'] = 'If the kilman is set to **Group Mode**: *Visible groups*, or is set to *Separate groups* and the current user
 has the *moodle/site:accessallgroups* capability (in the current context), and groups have been defined in the current course,
 then the user has access to a dropdown list of groups. This dropdown list enables the user to "filter" the kilman responses by groups.
...
$string['crontask'] = 'kilman cleanup job';